...
// TestDomainHasNoSchemaOrOrchestrationDependencies pins invariant A: the core
// domain package stays schema-blind and independent of orchestration,
// transport, and persistence.
func TestDomainHasNoJSONSchemaDependency(t *testing.T) {
	forbidden := []string{
...
func assertPackageImports(t *testing.T, dir string, forbidden []string) {
	t.Helper()
