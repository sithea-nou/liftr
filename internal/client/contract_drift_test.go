...
func TestClientRepresentationsMatchOpenAPI(t *testing.T) {
	...
	assertShapeMatches(t, schemas, "ResourceSummary", client.ResourceSummary{})
	assertShapeMatches(t, schemas, "ResourceSummaryStatus", client.ResourceSummaryStatus{})
	assertShapeMatches(t, schemas, "ResourceList", client.ResourceList{})
